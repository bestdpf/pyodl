...
class API(object):
    def __init__(self,odl,container='default',format='json'):
        ...
        self.base_sec_uri='https://'+self.odl.domain+':'+ self.odl.sec_port+'/controller/nb/v2'
        self.full_uri=None
        self.response=None
    ...
    def __request(self,request_data):
        ...
        self.response=self.method(self.full_uri,auth=self.odl.auth,data=request_data.data,headers=request_data.headers)
